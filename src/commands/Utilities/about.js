const { Command, version: akairo } = require('discord-akairo');
...
class About extends Command {
  ...
  async exec(message) {
    const embed = new MessageEmbed()
      .setThumbnail(
        this.client.user.displayAvatarURL({ size: 4096, dynamic: true })
      )
      .setColor('#00ff9e')
      .setTitle(`About ${this.client.user.username}`)
      .setImage(
        `https://cdn.discordapp.com/attachments/748808131865215004/764348102592430091/HeavyLikableFurseal-size_restricted.gif`
      )
      .setDescription(
      ...
      .addField('__General Details__', [
        ...
        `**❯ Created On:** ${utc(this.client.user.createdTimestamp).format(
          'Do MMMM YYYY HH:mm:ss'
        )}`,
        `**❯ Uptime:** ${ms(this.client.uptime, { long: true })}.`,
        `**❯ Developers:** Anish, Hound, Kartik, Piyush & Xynox.`,
        '\u200b',
      ])
      .addField(
      ...
      .addField(
        ...
        [
          ...
          `**❯ Discord-Akairo:** [v${akairo}](https://discord-akairo.github.io/#/docs)`,
